  ...
  <div class="footer">
    <div class="footer__container">
      <div class="footer__content">
        <div class="footer__column">
          <div class="footer__logo"><img src="/images/footer/logo.svg" alt="" /></div>
          ...
          <div class="footer__socials">
            <a href="#" class="footer__socials-a">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div class="footer__column">
          ...
          <router-link to="/caseStudies"><button>Case Studies</button></router-link>
          <router-link to="/Blog"><button>Blog</button></router-link>
          <router-link to="/Careers"><button>Careers</button></router-link>
        ...
        <div class="footer__column">
          <p>CONTACT US</p>
          <a class="footer__link" href="tel:(405) 555-0128">
            <svg
              width="10"
              height="16"
              viewBox="0 0 10 16"
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M2.66634 1.94857C2.11406 1.94857 1.66634 2.39628 1.66634 2.94857V13.0527C1.66634 13.605 2.11406 14.0527 2.66634 14.0527H7.33301C7.88529 14.0527 8.33301 13.605 8.33301 13.0527V2.94857C8.33301 2.39628 7.88529 1.94857 7.33301 1.94857H7.27742L7.11504 2.3382C7.01152 2.58661 6.76879 2.74842 6.49967 2.74842H3.49967C3.23056 2.74842 2.98783 2.58661 2.88431 2.3382L2.72193 1.94857H2.66634ZM0.333008 2.94857C0.333008 1.6599 1.37768 0.615234 2.66634 0.615234H7.33301C8.62167 0.615234 9.66634 1.6599 9.66634 2.94857V13.0527C9.66634 14.3414 8.62167 15.3861 7.33301 15.3861H2.66634C1.37768 15.3861 0.333008 14.3414 0.333008 13.0527V2.94857Z"
                fill="white"
              />
            </svg>
            (405) 555-0128
    ...
    <div class="footer__container">
      <ul class="footer__awards">
        <li><img src="/images/footer/award1.jpg" alt="" /></li>
        <li><img src="/images/footer/award2.jpg" alt="" /></li>
        <li><img src="/images/footer/award3.jpg" alt="" /></li>
        <li><img src="/images/footer/award4.jpg" alt="" /></li>
      </ul>
    </div>
    <div class="footer__end">
      <div class="footer__end-container">
        <p>
          © All rights reserved.Made with <img src="/images/footer/heart.svg" alt="" /> by Createx
          Studio
        </p>
      </div>
    </div>
